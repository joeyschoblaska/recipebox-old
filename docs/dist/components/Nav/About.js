...
const About = () => /* @__PURE__ */ React.createElement("div", {
  className: "bg-purple-500 p-6 font-mono text-sm text-purple-100"
...
}, "cuisine package"), " ", "for LaTeX, which groups instructions and ingredients together by step."), /* @__PURE__ */ React.createElement("ul", {
